    ...
    public partial class HomeForm : Form
    {
        ...
        private void Toppanel_MouseUp(object sender, MouseEventArgs e)
        {
                ...
                } else if (this.WindowState == FormWindowState.Maximized && start_point.Y == 0) //if cursor location on the top edge and the form Maximized
            {
                ...
                else if (this.WindowState == FormWindowState.Normal && start_point.Y == 0)    //if cursor location on the top edge and the form Normal
                {
                this.Size = Half;
                }
        ...
        private void Toppanel_DragDrop(object sender, DragEventArgs e)
        {
